...
char TxData1[8]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
//char TxData2[8]={0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
//char TxData3[8]={0x15,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
//char TxData4[8]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
        ...
        if( RxHeader.IDE == CAN_ID_EXT )
        {
            if (RxHeader.ExtId == 0x18FF228F )
            {
                if( Rx_Buffer[0] == 0x01)
                {
                	receivedBit = 1;
                	cnt++;
                	HAL_UART_Transmit(&huart2,cnt,sizeof(cnt),1000);
                }
...
//          TxData1[6] = 0x00;
//          TxData1[7] = 0x00;
          if(HAL_OK == HAL_CAN_AddTxMessage(&hcan1, &TxHeader, TxData1, &TxMailbox))
          {
        	  HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_5);
              HAL_Delay(300);
          }

          receivedBit = 0; // Reset receivedBit after processing
      }
  }
}
/**
